...
- [ ] Importer / saisir les **365 lignes** (1 par jour). Astuce : importer un CSV depuis les fichiers `defis/mois-XX` ou copier-coller par blocs. Renseigner Jour, Titre, Catégorie, Stat, Difficulté, Mois.
