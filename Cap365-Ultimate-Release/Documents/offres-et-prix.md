...
> ⚠️ **Noms d'offres canoniques.** Prix **19 / 39 / 89 €** — paliers **Le Sentier (19 €) · L'Ascension (39 €) ⭐ · Le Sommet (89 €)**. La valeur, l'ancrage et la structure décrits ci‑dessous sont la référence à respecter à la lettre.
...
|---|---|---|
| 1 | **Les 365 défis quotidiens** classés par niveau de difficulté progressif | Un pas concret chaque jour, jamais 365 d'un coup. La difficulté monte semaine après semaine. |
| 2 | **Le guide de démarrage « Tes 7 premiers jours »** | Le coup de pouce pour franchir la zone d'abandon des deux premières semaines. |
| 3 | **Le carnet de suivi imprimable** (séries, cases à cocher, journal de bord) | Une trace papier de ta régularité, à cocher chaque soir. |
| 4 | **L'accès au système de niveaux et d'XP de base** | Chaque défi validé compte : tu vois ton total grimper. |
...
**Calcul « valeur empilée » :**

| Composant | Valeur de référence estimée* |
|---|---|
| 365 défis structurés à difficulté progressive | 25 € |
| Guide de démarrage « 7 premiers jours » | 9 € |
| Carnet de suivi imprimable | 7 € |
| Système de niveaux & XP de base | 9 € |
| **Valeur empilée totale** | **≈ 50 €** |
| **Prix de vente** | **19 €** |
| **Ratio valeur / prix** | **≈ 2,6×** |

> 🧮 **Repère parlant :** à 19 € l'année, soit **≈ 5 centimes par défi**, le prix se justifie face au coût d'un seul livre de développement personnel (15-20 €) qui finira au fond d'un tiroir. C'est le ticket d'entrée **premium mais accessible**.

*\*Hypothèses raisonnables de marché, à ajuster selon le marché réel. Les valeurs de référence servent au cadrage de l'argumentaire, pas de prix barrés trompeurs.*
...
| 5 | **Le Filet de Reprise activé** (journées de grâce + rituel de reprise guidé) | Le mécanisme anti-abandon : un jour manqué ne casse plus tout. |

### 👤 Public cible
**Le cœur de cible** : celui qui veut le système complet, la gamification et l'accompagnement anti-abandon pour **vraiment tenir l'année** — et qui sait, au fond, qu'il a déjà lâché des challenges avant.

### 🎁 Bonus
| # | Bonus | Valeur ajoutée |
|---|---|---|
| 1 | **Pack « 30 défis bonus week-end »** | De quoi aller plus loin les jours où tu as plus de temps. |
| 2 | **Mini-guide « Construire une habitude qui tient »** (psychologie appliquée) | La méthode derrière la méthode, pour ancrer durablement. |
| 3 | **Wallpapers de motivation** (mobile + ordinateur) | Ton cap sous les yeux à chaque déverrouillage d'écran. |
...
| Filet de Reprise (journées de grâce + rituel guidé) | 15 € |
| 🎁 Bonus week-end + mini-guide habitude + wallpapers | 17 € |
| **Valeur empilée totale** | **≈ 141 €** |
| **Prix de vente** | **39 €** |
...
| 5 | **L'accès à vie aux mises à jour et nouveaux défis** ajoutés chaque année | Ton achat ne périme pas : il grandit avec le programme. |

### 👤 Public cible
**Le déterminé qui veut tout** : il prend son année au sérieux et veut un accompagnement complet sur les **4 piliers**, avec des bilans et un accès qui dure.

### 🎁 Bonus
| # | Bonus | Valeur ajoutée |
|---|---|---|
| 1 | **Pack « 100 défis hardcore »** | Pour les plus ambitieux qui veulent pousser l'inconfort plus loin. |
| 2 | **Bibliothèque audio de motivation quotidienne** | Ton coach dans les oreilles, chaque matin. |
| 3 | **Kit de défis à partager** (relever les défis à plusieurs) | Tu embarques un ami : la régularité tient mieux à deux. |
| 4 | **Accès prioritaire aux futures éditions et bonus exclusifs** | Toujours la dernière version, avant tout le monde. |
...
| Accès à vie aux mises à jour & nouveaux défis | 30 € |
| 🎁 Bonus : 100 défis hardcore + audio + kit à partager + accès prioritaire | 39 € |
| **Valeur empilée totale** | **≈ 295 €** |
| **Prix de vente** | **89 €** |
...
| Niveaux & XP de base | ✅ | ✅ | ✅ |
| Gamification complète (badges, trophées, classement) | — | ✅ | ✅ |
| Fiches des 52 thèmes hebdo | — | ✅ | ✅ |
| Tableau de bord interactif | — | ✅ | ✅ |
| **Filet de Reprise** (anti-abandon) | — | ✅ | ✅ |
...
| 🎁 Pack week-end + guide habitude + wallpapers | — | ✅ | ✅ |
| 🎁 100 défis hardcore + audio + kit à partager | — | — | ✅ |
| **Valeur empilée estimée\*** | ≈ 50 € | ≈ 141 € | ≈ 295 € |
| **Ratio valeur / prix** | ≈ 2,6× | **≈ 3,6×** | ≈ 3,3× |
| **Idéal pour** | Tester en autonomie | **Tenir toute l'année** | Tout avoir, à vie |

*\*Valeurs de référence = hypothèses raisonnables de marché, à ajuster. Servent au cadrage de l'argumentaire, pas de prix barrés.*
...
### Comment la mettre en avant
- ✅ La marquer **« Le plus populaire »** / **« Recommandé »** sur la grille de prix (colonne centrale, mise en valeur visuelle).
- ✅ La placer **au centre** des trois colonnes, en accent orange `#F5A623` (couleur d'action de la charte).
- ✅ En faire le **bouton par défaut** des CTA (« Je démarre ma transformation »).
- ✅ Argumentaire central : *« Pour le prix d'une seule séance de coaching, une année entière — avec le filet qui t'empêche d'abandonner. »*
