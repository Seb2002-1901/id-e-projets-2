...
5. **Les 365 défis** — 1 carte par défi (gabarit = `../SVG/composants/carte-defi.svg`). Contenu : `../CSV/defis-365-import-notion.csv`.
...
- Gabarit de carte : `../SVG/composants/carte-defi.svg`
